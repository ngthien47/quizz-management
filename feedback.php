      ...
      <div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:430px;">
        ...
        <div style="font-size:14px">
          <?php if (@$_GET['q'])
            ...
            echo ' 
You can send us your feedback through e-mail on the following e-mail:<br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<a href="mailto:thientn20@uef.edu.vn" style="color:#000000">thientn20@uef.edu.vn</a><br /><br />
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <a href="https://www.facebook.com/sunnygkp10" style="color:#202020; font-family:'typo' ; font-size:18px"
                title="Find on Facebook">Sunny Prakash Tiwari</a>
