...
<head>
  ...
  <title>UEF - Quizz Management</title>
...
<body style="background:#eee;">
  <div class="header">
    <div class="row">
      <div class="col-lg-6" style="height: 70px; display: grid; align-items: center; margin-left: 20px">
      ...
      if (!(isset ($_SESSION['email']))) {
        ...
        include_once 'dbConnection.php';
        echo '<span class="pull-right top title1" style="display: flex; align-items: center; height: 70px"" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1">' . $name . '</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
      } ?>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter title" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Enter marks for right answer" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Enter minus marks for wrong answer" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control" placeholder="Write description..."></textarea>  
  </div>
</div>
